  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section className="text-center py-12 bg-blue-50 rounded-2xl border border-blue-100">
          ...
          <p className="text-gray-500 text-sm mb-6">Chairs from $2/each · Tables from $10/each · Packages available</p>
