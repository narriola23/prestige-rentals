...
async function getWaterUnits() {
  try {
    ...
    return products.filter((p: any) => p.is_active && p.wet_dry && p.wet_dry !== "Dry");
  } catch {
    return [];
  }
}
...
export default async function SummerWaterSlidePage() {
  const products = await getWaterUnits();
  ...
  return (
    <>
      <section className="bg-blue-950 text-white py-14 text-center">
        ...
        <h1 className="text-4xl font-black mb-3">Summer Water Party</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          {products.length > 0 && (
            <>
              <h2 className="text-2xl font-black text-blue-950 mb-8 text-center">Choose Your Water Unit</h2>
        ...
        <section className="bg-yellow-500 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-black text-blue-950 mb-2">Ready to Book Your Summer Water Party?</h2>
